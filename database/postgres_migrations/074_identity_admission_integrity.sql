...
-- the canonical entity base.  Historical non-accepted evidence may retain other
-- candidate counts for audit.
...
-- new invalid admissions; the view also excludes any historical rows that may
-- predate this migration or have been loaded with triggers intentionally disabled.
