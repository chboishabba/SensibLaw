...
def test_build_nat_cohort_b_operator_evidence_index_matches_pinned_fixture() -> None:
    ...
    batch2 = _load_fixture(
        "wikidata_nat_cohort_b_operator_batch_report_case2_20260402.json"
    )
...
def test_build_nat_cohort_b_operator_evidence_index_holds_on_insufficient_ready_batches() -> (
    None
):
    batch1 = _load_fixture("wikidata_nat_cohort_b_operator_batch_report_20260402.json")
