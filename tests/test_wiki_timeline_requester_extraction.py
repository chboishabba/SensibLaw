...
def test_extract_requester_with_title(nlp):
    ...
    surf, resolved, has_title = ext._extract_requester_from_doc(
        doc, {"Bush": "George W. Bush"}
    )
...
def test_extract_requester_from_request_verbs_direct(nlp):
    ...
    surf, resolved, src = ext._extract_requester_from_request_verbs(
        doc, {"Congress": "United States Congress"}
    )
