...
MIGRATION = ROOT / "database" / "postgres_migrations" / "030_durable_work_item_resume.sql"
OUTBOX = ROOT / "database" / "postgres_migrations" / "027_semantic_execution_outbox_triggers.sql"
