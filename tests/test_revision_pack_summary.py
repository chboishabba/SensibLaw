...
def test_revision_pack_summary_builds_triage_and_human_summary() -> None:
    ...
    assert 'pair_report_path' not in payload['pack_triage']['top_high_severity_pairs'][0]
    assert 'contested_graph_path' not in payload['pack_triage']['top_contested_graphs'][0]
