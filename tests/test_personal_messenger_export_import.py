...
from scripts.build_personal_handoff_from_messenger_export import (
    build_handoff_from_messenger_export_artifact,
    main,
)
...
def test_messenger_export_builds_protected_envelope_without_raw_text(
    tmp_path: Path,
) -> None:
    payload = build_handoff_from_messenger_export_artifact(
        export_path=_FIXTURE_PATH,
    ...
    assert normalized["entries"][0]["local_handle"].startswith(
