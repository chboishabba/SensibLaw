...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "projections_actor",
            lambda: routes.obligations_projections("actor", _extract_obligations()),
        ),
        (
            "projections_action",
            lambda: routes.obligations_projections("action", _extract_obligations()),
        ),
        (
            "projections_clause",
            lambda: routes.obligations_projections("clause", _extract_obligations()),
        ),
        (
            "projections_timeline",
            lambda: routes.obligations_projections("timeline", _extract_obligations()),
        ),
        (
            "activation",
