        ...
        "facts": [
            {
                ...
                "source_types": ["wiki_article"],
                "statement_texts": [
                    "Revision by Alice: Reverted vandalism because of wrong info"
                ],
            }
        ]
    }
        ...
        "facts": [
            {
                ...
                "source_types": [
                    "wiki_article"
                ],  # This implies public_summary lexically
                "statement_texts": ["Revision by Alice: Fixed typo"],
            }
        ]
    }
