...
SOURCE_SLICE_PATH = (
    ...
    / "fixtures"
    / "zelph"
    / "au_public_handoff_v1"
    / "au_public_handoff_v1.slice.json"
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build the checked AU affidavit-coverage review artifact."
    )
    parser.add_argument(
        "--output-dir",
