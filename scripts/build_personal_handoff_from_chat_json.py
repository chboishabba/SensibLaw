...
def build_handoff_from_chat_artifact(
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build a personal handoff or protected disclosure artifact from bounded chat/day JSON."
    )
    parser.add_argument(
        "--input-json",
        required=True,
        help="JSON file describing chat/day messages and handoff mode.",
    )
    parser.add_argument(
        "--output-dir",
        required=True,
        help="Directory to write normalized input and report artifacts.",
    )
