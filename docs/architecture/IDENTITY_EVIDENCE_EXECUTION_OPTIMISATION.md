...
## Migration 082: bounded factor-composition work
...
Migration 082 performs deterministic pair enumeration inside `LATERAL ... LIMIT
K` and adds `semantic_pnf_factor_composition_overflow`.
