...
def canonical_us_jurisdictions() -> list[dict[str, str]]:
    jurisdictions: Iterable[USJurisdiction] = (
        USJurisdiction(
            code="US.FED",
            label="United States Federation",
            type="federal",
            sovereign="US",
        ),
        ...
        USJurisdiction(
            code="US.PR", label="Puerto Rico", type="territory", sovereign="US"
        ),
        USJurisdiction(code="US.GU", label="Guam", type="territory", sovereign="US"),
        USJurisdiction(
            code="US.VI", label="U.S. Virgin Islands", type="territory", sovereign="US"
        ),
        USJurisdiction(
            code="US.AS", label="American Samoa", type="territory", sovereign="US"
        ),
    )
